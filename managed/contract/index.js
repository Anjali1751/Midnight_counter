...
export var State;
(function (State) {
  State[State['UNCLAIMED'] = 0] = 'UNCLAIMED';
  State[State['CLAIMED'] = 1] = 'CLAIMED';
})(State || (State = {}));
...
export class Contract {
  ...
  _claim_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            0,
                            'Counter already claimed');
    const tmp_0 = this._ownerCommitment_0(this._localSecretKey_0(context,
                                                                 partialProofData));
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
  ...
  _increment_0(context, partialProofData) {
    __compactRuntime.assert(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            1,
                            'Counter has not been claimed yet');
    __compactRuntime.assert(this._equal_0(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          this._ownerCommitment_0(this._localSecretKey_0(context,
                                                                                         partialProofData))),
